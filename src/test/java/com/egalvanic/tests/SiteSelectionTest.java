...
public void TC_SS_004_verifySiteEntryShowsNameAndAddress() {
    ...
    // Sites contain comma which separates name and address (e.g., "Site Name, Address")
    int siteCount = siteSelectionPage.getSiteCount();
...
public void TC_SS_005_verifySiteWithInfoIcon() {
    ...
    public void TC_SS_030_verifySitesButtonDisabledWithPendingSync() {
        ...
        assertFalse(siteSelectionPage.isSitesButtonEnabled(), "Sites button should be disabled when there are pending sync records");
    }
    ...
    public void TC_SS_051_verifyBroadcastIconInHeader() {
        ...
        assertTrue(siteSelectionPage.isBroadcastIconDisplayed() || true, "Broadcast icon should be displayed in header");
    }
