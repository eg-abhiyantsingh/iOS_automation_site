 ...
 */
public class demo_justforTesting {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (WebElement btn : allButtons) {
                ...
                if (name != null && !name.equals("Emoji") && !name.equals("dictation") && !name.equals("Create New Site") && !name.equals("Cancel") && !name.equals("xmark.circle.fill") && name.contains(",")) {
                    sites.add(btn);
                }
            }
            ...
            if (sites.size() > 0) {
                ...
                System.out.println("✅ Selected site: " + siteName + " (Index: " + randomIndex + " of " + sites.size() + ")");
            } else {
...
driver.findElement(AppiumBy.iOSClassChain("**/XCUIElementTypeWindow[1]/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther")).click();
...
driver.findElement(AppiumBy.iOSNsPredicateString("type == 'XCUIElementTypeTextField' AND value == 'Building Name'")).click();
Thread.sleep(500);
driver.findElement(AppiumBy.iOSNsPredicateString("type == 'XCUIElementTypeTextField' AND value == 'Building Name'")).sendKeys("1");
