...
| **Total (analyzable)** | **220** | **129** | **31** | **60** | — | — |

**Still running**: Assets P1 (112, ~149min left), Assets P3 (109, ~228min), Offline (35), Assets P5 (112), Issues P3 (58)  
**Queued**: Assets P4 (97), Issues P1 (119), Connections (94)
...
| Metric | Value |
|--------|-------|
| Total tests attempted | 220 |
| Tests passed | 129 (58.6%) |
| Tests failed (timeout) | 31 (14.1%) |
| Tests cascade-skipped | 60 (27.3%) |
| CI time wasted on timeouts | ~245 minutes (31 × 7min + teardown hangs) |
| Unique root causes | 3 (offline incompatibility, Appium hangs, cascade bug) |
